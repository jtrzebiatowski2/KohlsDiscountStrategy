...
public class productAndCustomerDatabase {
    ...
    static{
        products[0] = new Product(1, "400 Thread Count Queen Sheets", 49.99);
        products[1] = new Product(2, "Pumpkin Candle", 12.99);
        products[2] = new Product(3, "Boys sz 13 Spiderman Shirt", 10.49);
        products[3] = new Product(4, "Men's sz 12 Loafers", 79.99);
        products[4] = new Product(5, "Rachel Ray 12 inch frying pan", 89.99);
        products[5] = new Product(6, "Juniors sz 3 hip flare pant", 29.99);
        products[6] = new Product(7, "Apt 9 fashion tie", 23.99);
        products[7] = new Product(8, "Men's Hanes white A-shirt 3 count", 14.99);
        products[8] = new Product(9, "Fashion Plus Silverware set", 99.99);
        products[9] = new Product(10, "Girl's 10 pack socks", 13.99);
